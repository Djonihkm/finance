...
import { ArrowLeft, CheckCircle, XCircle, Printer, FileText, Receipt } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-6">
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-xl p-5 shadow-sm">
              ...
              <button className="w-full bg-red-500 hover:bg-red-600 text-white py-3 rounded-lg font-semibold text-sm flex items-center justify-center gap-2 transition-colors cursor-pointer shadow-sm">
                <XCircle size={18} />
                Rejeter
              </button>
