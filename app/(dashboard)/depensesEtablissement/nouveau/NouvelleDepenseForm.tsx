...
import { ArrowLeft, ArrowRight, FileText, Landmark, Wallet, UploadCloud, CheckCircle2, X, Paperclip, BookOpen } from "lucide-react";
...
export default function NouvelleDepenseForm({ comptes }: Props) {
  ...
  const handleSubmit = async () => {
    ...
    if (!form.compteId) { toast.error("Le compte de charge est requis."); return; }
    ...
    try {
      const res = await fetch("/api/depenses", {
        ...
        body: JSON.stringify({
          ...
          compteId: parseInt(form.compteId),
        }),
      });
      if (!res.ok) {
        const err = await res.json().catch(() => ({}));
  ...
  const selectedCompte = comptes.find((c) => c.id === parseInt(form.compteId));
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8">
              ...
              <div className="space-y-5">
                ...
                {/* Compte de charge */}
                <div>
                  <label className={labelClass}>Compte de charge</label>
                  <select name="compteId" value={form.compteId} onChange={handleChange} className={inputClass}>
            ...
            <div className="lg:sticky lg:top-6 space-y-4">
              <div className="bg-white border border-gray-100 rounded-xl shadow-sm p-6">
                ...
                <div className="space-y-4">
                  ...
                  <RecapItem
                    label="Compte"
                    value={selectedCompte ? `${selectedCompte.numero} - ${selectedCompte.nom}` : ""}
                  />
                  <RecapItem
                    label="Montant"
