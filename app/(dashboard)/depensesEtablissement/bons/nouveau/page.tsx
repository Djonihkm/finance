/**
 * app/(dashboard)/depensesEtablissement/bons/nouveau/page.tsx — Client Component
 * ────────────────────────────────────────────────────────────────────────────────
 * Formulaire de création d'un bon de commande.
 * Soumet via POST /api/bons-commande puis redirige vers la liste.
 *
 * Flux : ici → POST /api/bons-commande → router.push('/depensesEtablissement')
 */
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-10">
              ...
              <div className="flex flex-col md:flex-row justify-between items-start gap-6 mb-10 pb-6 border-b border-gray-100">
                ...
                <div className="text-xs text-gray-600 text-right leading-relaxed">
                  ...
                  <p>12<sup>e</sup> arr., Cotonou, Bénin</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-gray-100">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm text-gray-700 placeholder:text-gray-400 italic focus:outline-none focus:ring-2 focus:ring-[#11355b]/20 focus:border-[#11355b] transition-all resize-none mb-3"
                  />
                  <div>
                    <p className="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">Fait à</p>
                    <input
                      type="text"
                      value={bonData.faitA}
