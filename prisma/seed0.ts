...
async function main() {
  ...
  const devPw    = e("SEED_DEV_PASSWORD");
  const minPw    = e("SEED_MINISTERE_PASSWORD");
  const etabPw   = e("SEED_ETAB_PASSWORD");
